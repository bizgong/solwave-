              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                    ...
                    <div>
                        ...
                        <p className="text-brand-muted text-sm leading-relaxed">강원도 속초시 해오름로 123번길 45<br/>(속초해수욕장 도보 3분)</p>
                    </div>
                </div>
                <div className="flex items-start space-x-4">
                     <div className="p-2 bg-brand-surface rounded-full text-brand-accent">
                ...
                <div className="flex items-start space-x-4">
                    ...
                    <div>
                        ...
                        <p className="text-brand-accent font-bold text-xl">010-1234-5678</p>

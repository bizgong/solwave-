    ...
    <div className="w-full bg-brand-bg">
      ...
      <section className="relative h-screen w-full overflow-hidden bg-gray-200">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          <FadeIn>
            <h2 className="text-white text-sm md:text-base tracking-[0.3em] font-medium mb-4 drop-shadow-md">
              속초 프라이빗 풀빌라
            </h2>
          </FadeIn>
          <FadeIn delay={0.2}>
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight drop-shadow-lg">
              솔웨이브<br />
              <span className="text-3xl md:text-4xl font-light block mt-4 tracking-wider">풀빌라 & 리조트</span>
            </h1>
          </FadeIn>
          <FadeIn delay={0.4}>
            <p className="text-white/90 text-lg md:text-xl font-light mb-10 max-w-2xl mx-auto drop-shadow-md leading-relaxed">
              파도와 하늘 사이, 당신만의 프라이빗한 휴식처.<br/>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <FadeIn>
            <div className="text-center mb-16">
              <span className="text-brand-accent font-bold tracking-widest text-sm block mb-2">스페셜</span>
              <h2 className="text-3xl md:text-4xl font-bold mb-4 text-brand-text">시그니처 포인트</h2>
      ...
      <section className="py-24 bg-brand-surface relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex justify-between items-end mb-16">
            <FadeIn>
              <h2 className="text-3xl md:text-4xl font-bold mb-2 text-brand-text">객실 안내</h2>
              <p className="text-brand-muted">당신의 여행 스타일에 맞는 객실을 선택하세요</p>
            </FadeIn>
            <FadeIn delay={0.2}>
              <button 
                onClick={() => navigate('/rooms')}
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <FadeIn>
            <div className="text-center mb-16">
               <h2 className="text-3xl font-bold mb-4">이용 후기</h2>
               <p className="text-brand-muted">솔웨이브를 다녀가신 분들의 소중한 이야기</p>
            </div>
          </FadeIn>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <section className="py-24 bg-brand-surface">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <FadeIn>
            ...
            <p className="text-brand-muted mb-10">속초해변 도보 3분 · 속초 시내 10분 거리의 완벽한 접근성</p>
            ...
            <div className="text-center px-6 relative z-10">
                <FadeIn>
                  <h2 className="text-3xl md:text-5xl font-bold mb-6 text-white leading-tight">
                    가장 좋은 날짜는 <br className="md:hidden"/>빠르게 마감됩니다.
                  </h2>
                  <p className="text-white/60 mb-10 text-lg">
                    지금 바로 솔웨이브에서 잊지 못할 추억을 예약하세요.
                  </p>
                  <button 
                    onClick={() => navigate('/contact')}
